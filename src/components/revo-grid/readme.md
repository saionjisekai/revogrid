...
| `rowProperties`      | `row-properties`   | Row properties function. This function will be called on each rgRow object and can be used to define additional properties.                                                                                                                             | `RevoGrid.RowPropertiesFunc`                                                                                                                                                                                                | `undefined` |
